                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <div class="text-center mb-3">
                                ...
                                <h5 class="mb-0">Entre Para Sua Conta</h5>
                                <span class="d-block text-muted">Seus credencias</span>
                            </div>
                            ...
                            <div class="form-group d-flex align-items-center">
                                ...
                                <a href="" class="ml-auto">Esqueceu Sua Palavra Passe?</a>
                            </div>
                           ...
                           {{-- <div class="form-group">
                                <a href="#" class="btn btn-light btn-block"><i class="icon-home"></i> Ir Para Pagina Principal</a>
                            </div>--}}
