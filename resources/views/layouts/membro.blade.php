    ...
    ***********************************-->
    <div id="main-wrapper">
                        ...
                        <ul class="navbar-nav header-right main-notification">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="/img/filo.png" width="20" alt="" class="rounded-circle">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<div class="main-profile">
					<div class="image-bx">
						<img src="/img/filo.png" class="rounded-circle" alt="">
						<a href="javascript:void(0);"><i class="fa fa-cog" aria-hidden="true"></i></a>
					</div>
					<h5 class="name"><span class="font-w400">Hello,</span> Felismino</h5>
					<p class="email"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="95f8f4e7e4e0f0efefefefd5f8f4fcf9bbf6faf8">[muchombo2021@gmail.com]</a></p>
				</div>
				<ul class="metismenu" id="menu">
					<li class="nav-label first">Main Menu</li>
                    <li class="nav-item  {{'membro-dashboard' == request()->path() ? 'active': ''}}">
						<a href="/membro-dashboard" aria-expanded="false">
							<i class="flaticon-144-layout"></i>
							<span class="nav-text">Dashboard </span>
						</a>          
                    </li>	
					
					<li class="nav-item  {{'dados_user' == request()->path() ? 'active': ''}}">
						<a  href="/dados_user" >
						<i class="flaticon-144-layout"></i>
						<span class="nav-text">Dados Pessoas</span>
					</a>          
				</li>

				<li class="nav-item {{'reclamar_milha' == request()->path() ? 'active': ''}}">
						<a  href="/reclamar_milha" >
						<i class="flaticon-144-layout"></i>
						<span class="nav-text"> <ion-icon name="airplane-outline"></ion-icon>Reclamar Milhas</span>
					</a>          
				</li>
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head mb-sm-5 mb-3 d-flex flex-wrap align-items-center">
					<h2 class="font-w600 title mb-2 mr-auto ">@yield('titulo')</h2>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright ">
                <p class="text-center">Copyright ©  &amp; Developed by FELISMINO 2021</p>
            </div>
        </div>
    </div>
    <!-- Required vendors -->
